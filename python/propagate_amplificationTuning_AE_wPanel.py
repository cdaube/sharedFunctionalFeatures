        ...
        for id in range(2):
            for rs in range(1):
                for bhv in range(3):
                    ...
                    ths_txt = basePth+'ss'+str(ss+1)+'/'+genderTxt[gg]+'/id'+str(id+1)+'/AE_'+bhvType[bhv]+'_'+rsType[rs]+'/linksToImages.txt'
                    ...
                    for bb in range(nBatch):
                        ...
                        thsDestinDir = proj0257Dir+'humanReverseCorrelation/amplificationTuning/wPanel/AE_'+bhvType[bhv]+'_'+rsType[rs]+'/ss'+str(ss+1)+'/'+genderTxt[gg]+'/id'+str(id+1)+'/'
