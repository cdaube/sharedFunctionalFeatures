...
% importantly, here, the trial order of the behavioural responses is
% shuffled differently in a number of repetitions to get an idea of the
% chance level of predictions
...
fspcSel = [1 8 11 20 2 6 7 13 14 15 21 22];
fspcSel = [26:28];
