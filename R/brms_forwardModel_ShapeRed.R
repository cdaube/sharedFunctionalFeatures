  ...
  fileNameSource <- paste("forwardModel_shapeRedundancy.mat", sep = "")
  ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_forwardModelShapeRed.mat",sep = ""),extractedFit=extractedFit)
  # ... including names ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_forwardModelShapeRed_names.mat",sep = ""),names=names(brmsFit))
  # ... and model
  save(brmsModel, file=paste(rootDir,destinFolder,"brmsModel_forwardModelShapeRed.rda",sep = ""))
  #}
  ...
  writeMat(paste(rootDir,destinFolder,"hypotheses_forwardModelShapeRed.mat",sep = ""),evidenceRatios=evidenceRatios,pp=pp)
