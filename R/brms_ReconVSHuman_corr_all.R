  ...
  fileNameSource <- paste("reverseRegression_HumannessCorrAll.mat", sep = "")
  ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_ReconVSHumancorr_all.mat",sep = ""),extractedFit=extractedFit)
  # ... including names ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_ReconVSHumancorr_all_names.mat",sep = ""),names=names(brmsFit))
  # ... and model
  save(brmsModel, file=paste(rootDir,destinFolder,"brmsModel_ReconVSHumancorr_all.rda",sep = ""))
  #}
  
  # hypotheses
  load(paste(rootDir,destinFolder,"brmsModel_ReconVSHumancorr_all.rda",sep = ""))
  ...
  writeMat(paste(rootDir,destinFolder,"hypotheses_ReconVSHumancorr_all.mat",sep = ""),evidenceRatios=evidenceRatios,pp=pp)
