  ...
  fileNameSource <- paste("forwardModels_panelAccuracy_cpa.mat", sep = "")
  ...
  png(file="M_panelAccuracy_cpa_chains.png")
  plot(brmsModel, ask = FALSE, N = 15)
  dev.off()

  png(file="M_panelAccuracy_cpa_ppCheck.png")
  pp_check(brmsModel)
  dev.off()
  ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_panelAccuracy_cpa.mat",sep = ""),extractedFit=extractedFit)
  # ... including names ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_panelAccuracy_cpa_names.mat",sep = ""),names=names(brmsFit))
  # ... and model
  save(brmsModel, file=paste(rootDir,destinFolder,"brmsModel_panelAccuracy_cpa.rda",sep = ""))
  #}
  
  # hypotheses
  load(paste(rootDir,destinFolder,"brmsModel_panelAccuracy_cpa.rda",sep = ""))
