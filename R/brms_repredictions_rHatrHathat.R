  ...
  fileNameSource <- paste("rePredictionsPerformances.mat", sep = "")
  ...
  png(file="M_repredictionsRHatRHatHat_chains.png")
  plot(brmsModel, ask = FALSE, N = 15) # thank you Jack E. Taylor for making me aware of the N argument <3
  dev.off()

  png(file="M_repredictionsRHatRHatHat_ppCheck.png")
  pp_check(brmsModel)
  dev.off()
  ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_repredictionsRHatrHatHat.mat",sep = ""),extractedFit=extractedFit)
  # ... including names ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_repredictionsRHatrHatHat_names.mat",sep = ""),names=names(brmsFit))
  # ... and model
  save(brmsModel, file=paste(rootDir,destinFolder,"brmsModel_repredictionsRHatrHatHat.rda",sep = ""))
  #}
  
  # hypotheses
  load(paste(rootDir,destinFolder,"brmsModel_repredictionsRHatrHatHat.rda",sep = ""))
  ...
  writeMat(paste(rootDir,destinFolder,"hypotheses_repredictionsRHatrHatHat.mat",sep = ""),evidenceRatios=evidenceRatios,pp=pp)
