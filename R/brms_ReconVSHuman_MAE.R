  ...
  fileNameSource <- paste("ReconVsHuman_MAE.mat", sep = "")
  ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_ReconVSHumanMAE.mat",sep = ""),extractedFit=extractedFit)
  # ... including names ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_ReconVSHumanMAE_names.mat",sep = ""),names=names(brmsFit))
  # ... and model
  save(brmsModel, file=paste(rootDir,destinFolder,"brmsModel_ReconVSHumanMAE.rda",sep = ""))
  #}
  
  # hypotheses
  load(paste(rootDir,destinFolder,"brmsModel_ReconVSHumanMAE.rda",sep = ""))
  ...
  writeMat(paste(rootDir,destinFolder,"hypotheses_ReconVSHumanMAE.mat",sep = ""),evidenceRatios=evidenceRatios,pp=pp)
