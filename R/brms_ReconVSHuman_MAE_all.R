  ...
  fileNameSource <- paste("reverseRegression_HumannessMAEAll.mat", sep = "")
  ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_ReconVSHumanMAE_all.mat",sep = ""),extractedFit=extractedFit)
  # ... including names ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_ReconVSHumanMAE_all_names.mat",sep = ""),names=names(brmsFit))
  # ... and model
  save(brmsModel, file=paste(rootDir,destinFolder,"brmsModel_ReconVSHumanMAE_all.rda",sep = ""))
  #}
  
  # hypotheses
  load(paste(rootDir,destinFolder,"brmsModel_ReconVSHumanMAE_all.rda",sep = ""))
  ...
  writeMat(paste(rootDir,destinFolder,"hypotheses_ReconVSHumanMAE_all.mat",sep = ""),evidenceRatios=evidenceRatios,pp=pp)
