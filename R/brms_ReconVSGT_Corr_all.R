  ...
  fileNameSource <- paste("reverseRegression_VeridicalityCorrAll.mat", sep = "")
  ...
  names(thsTable) <- c("coll","pps","fspc","Human","Texture","Shape","PCA","Triplet",
                  ...
                  "eucFitAE","eucFitVIAE","eucFitVAE","dnClassID","dnClassMulti","ldnVAE","nldnVAE","r")
  ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_ReconVSGTCorr_all.mat",sep = ""),extractedFit=extractedFit)
  # ... including names ...
  writeMat(paste(rootDir,destinFolder,"extractedFit_ReconVSGTCorr_all_names.mat",sep = ""),names=names(brmsFit))
  # ... and model
  save(brmsModel, file=paste(rootDir,destinFolder,"brmsModel_ReconVSGTCorr_all.rda",sep = ""))
  #}
  
  # hypotheses
  load(paste(rootDir,destinFolder,"brmsModel_ReconVSGTCorr_all.rda",sep = ""))
  ...
  writeMat(paste(rootDir,destinFolder,"hypotheses_ReconVSGTCorr_all.mat",sep = ""),evidenceRatios=evidenceRatios,pp=pp)
